...
INSERT INTO `commits` VALUES ('2', '4', '傻逼原批');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('0', 'Leader', 'user1', 'password', 'USERTEST', 'NjE2MzQwMzg4', '/img/avatar/-794026537.jpg');
...
CREATE TABLE `weapons` (
  ...
  `basic_attribute1` varchar(255) DEFAULT NULL,
  `basic_attribute2` varchar(255) DEFAULT NULL,
  `atk` int DEFAULT NULL,
  `sec_attribute` varchar(255) DEFAULT NULL,
...
INSERT INTO `weapons` VALUES ('4', '磐岩结绿', '单手剑', '5星', '限定祈愿', '暴击率9.6%', '基础攻击力44', '542', '暴击率44.1%', '护国的无垢之心：生命值提升20%/25%/30%/35%/40%。此外，基于装备该武器的角色生命值上限的1.2%/1.5%/1.8%/2.1%/2.4%,获得攻击力加成。', '/img/weapon/icon_panyanjielv.png', '2,');
